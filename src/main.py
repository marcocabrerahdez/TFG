...
from model import gradient_boosting_regressor as gradient_boosting_regressor_model
...
def main():
    ...
    # Modelo de gradiente de regresión
    gradient_boosting_regressor_model.gradient_boosting_regressor_model(df);
